...
<div id="mainAdminContents" class="content" style="padding-bottom: 100px;">
		...
		<div class="informations">
			<a href=
				...
				<?php 
					...
					echo "transactionControlPage.php?transaction=" . base64_encode('AdminAccountInformation');
		...
		<div class="informations">
			<form method="post" id="formdata">
				...
				<div class="informations" style="text-align: center;">
					<button class="adminButton" >Submit</button>
				</div>
			</form>
		</div>
...
const reference =  window.reference = '<?= $_SESSION['MAIN_account_id'] ?>';
