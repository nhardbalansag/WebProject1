...
<div id="mainAdminContents">
	<div id="content" class="content" style="padding-bottom: 70px;">
 			...
 			<div style="text-align: center;">
 				<p style="font-size: 20px; font-weight: bolder;">edit color</p>
 				<p id="result"></p>
	 		</div>
	 		<div style="text-align: center;">
	 			<div class="searchDiv">
	 			...
	 			<div class="ProductInfoDiv">
					<a class="mobileContentButton buttonDivProduct" href=
						...
						<div class="icontittle">
							<p >view all colors of this product</p>
						</div>
					</a>
	 			</div>
 ...
 <script type="text/javascript">
 	...
 	const computed_hash = window.some_variable = '<?= $_GET['editColor']?>';

 	const apiLinkread = '../../../../api/creator/admin/product/readOneColor.php';
 	const apiLinkcreate = '../../../../api/creator/admin/product/editColor.php';
	       ...
	       if (request.readyState === 4) {   // XMLHttpRequest.DONE == 4
	            ...
	            if (request.status === 200) {
	            	...
	            	if(res.response.http_response_code === 200 && res.response.reason === 'success'){
	           			...
	           			pct_tittle.innerHTML = res.response.display.result.c_name_field;
       ...
       if (request.readyState === 4) {   // XMLHttpRequest.DONE == 4
            ...
            if (request.status === 200) {
            	...
            	if(res.response.http_response_code === 200 && res.response.reason === 'success'){
            		...
            		c_name_field.value = res.response.display.result[0].color_c_name;
