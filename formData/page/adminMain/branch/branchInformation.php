	...
	.categories{
		...
		<div id="mainAdminContents">
 			...
 			<div style="text-align: center;">
 				<p style="font-size: 20px; font-weight: bolder;">branch informations</p>
	 		</div>
	 			...
	 			<div class="category">
					<a class="mobileContentButton" href=
						...
						<?php 
							...
							echo "branchControlPage.php?branch=" . base64_encode('viewAndAddLink');
		 		...
		 		<div class="category">
					<a class="mobileContentButton" href=
						...
						<?php 
							...
							echo "branchControlPage.php?branch=" . base64_encode('viewAndAddEmail');
		 		...
		 		<div class="category">
					<a class="mobileContentButton" href=
						<?php 
							...
							echo "branchControlPage.php?branch=" . base64_encode('viewAndAddContact');
		 		...
		 		<div class="category">
					<a class="mobileContentButton" href=
						<?php 
							...
							echo "branchControlPage.php?branch=" . base64_encode('editBranchInformation');
	 		...
	 		<div style="margin:auto; width: 80%; ">
	 			<div style="background-color:rgb(10,15,42); width: 100%; margin:auto; border-radius: 10px;">
