...
<div id="content">
		...
		<div class="informations">
			...
			<div style="display: flex; justify-content: space-around; align-items: center;">
				<p style="font-weight: bolder; font-size: 30px;">inquiry</p>
			</div>		
		</div>
		<div class="informations" style="margin-top: 5%; text-align: center; ">
			...
			<p>message:</p>
				<p style="color: rgb(56, 80, 128);" id="inquiryMessage">
...
var APIgetOneCustomerInquiry = '../../../api/creator/support/viewCustomerInquiryPersonalInfo.php';
getInquiryId();
...
function getInquiryId(){
  ...
  var data = {
      inquiryInformationID:{
        "id": window.reference = '<?= $_SESSION['customerInquiryID'] ?>'
      }
    };
