...
// localhost/my_projects/YAMAHA_PROJECT/api/creator/admin/product/readOneSpecification.php
	...
	if(!($stmt = $product->readOneSpecification())){
	...
	$data = array(
		's_id' => $stmtdata['s_id'],
		's_specification_type' => $encrypt->decryptData($stmtdata['s_specification_type'], $key),
		's_description' => $encrypt->decryptData($stmtdata['s_description'], $key),
		's_category' => $stmtdata['s_category'],
		'p_id' => $stmtdata['p_id'],
