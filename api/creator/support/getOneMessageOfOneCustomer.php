...
// localhost/my_projects/YAMAHA/api/creator/support/getOneMessageOfOneCustomer.php
	...
	$customer_user->computed_hash = $raw->messageReference->reference;

	if(!($stmt = $customer_user->getOneAccountSelectedMessage())){
		goto errorResult;
	}
	...
	$result = array(
		...
		'createdMessage' => array(
			...
			"createdCustomerMessageId" => $data['createdCustomerMessageId']						
	...
	$status = 200;
	$error = 'none';
	$message = $result['personalInformation']['ci_firstname'] . ' message';
